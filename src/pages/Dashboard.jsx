...
import { MdPeople, MdWork, MdVerifiedUser, MdPerson, MdBusiness, MdMail, MdDescription } from 'react-icons/md';
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card>
            <Statistic
              ...
              value={stats.candidateProfiles || 0}
              prefix={<MdPerson />}
              className="stats-card"
            />
          </Card>
